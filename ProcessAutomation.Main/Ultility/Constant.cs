...
namespace ProcessAutomation.Main.Ultility
{
    public class Constant
    {
        ...
        public const string REG_EXTRACT_ACCOUNT = "( ND | do | IBFT | N D )+(cb|hl|gd|nt)+(.*? )";
        public static List<string> WEBS_NAME = new List<string> { "cb", "hl", "gd", "nt" };
        #endregion

        #region Limitation
        public const decimal SATISFIED_PAYIN = 20000;
        public const decimal AMOUNT_ACCOUNT_CB = 10000000; //10000000
        public const decimal AMOUNT_ACCOUNT_HL = 10000000; //5000000
